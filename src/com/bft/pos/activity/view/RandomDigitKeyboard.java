 ...
 * 数字密码键盘
 */
public class RandomDigitKeyboard extends Keyboard {

	public RandomDigitKeyboard(Context context, int xmlLayoutResId) {
	...
	public RandomDigitKeyboard(Context context, int xmlLayoutResId, int modeId) {
		super(context, xmlLayoutResId, modeId);
	}

	public RandomDigitKeyboard(Context context, int layoutTemplateResId,
