...
public class BankSearchActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout ll_search = (LinearLayout) this
	...
	// ArrayList<BankModel> tmp_array = (ArrayList<BankModel>)
	// recievMap.get("object");
	...
	public void fromLogic(HashMap<String, Object> map) {
		recievMap = map;
		ArrayList<BankModel> tmp_array = (ArrayList<BankModel>) recievMap
				.get("object");
		for (int i = 0; i < tmp_array.size(); i++) {
			BankModel object = tmp_array.get(i);
			arrayList.add(object);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (currentPage + 1 < totalPage) {
				if (position == arrayList.size()) {
					...
					holder.tv_content.setText(((BankModel) (arrayList
				...
				holder.tv_content
						.setText(((BankModel) (arrayList.get(position)))
								.getName());
			}
