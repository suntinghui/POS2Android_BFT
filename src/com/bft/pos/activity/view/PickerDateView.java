...
//        sDay = 1;
        ...
        String date_interva = DateUtil.getDateByDay(interva);
        sYear = Integer.valueOf(date_interva.split("-")[0]);
        sMonth = Integer.valueOf(date_interva.split("-")[1])-1;
        sDay = Integer.valueOf(date_interva.split("-")[2]);
	...
	public String getToday(){
		return new StringBuilder().append(c.get(Calendar.YEAR)).append("-").append(c.get(Calendar.MONTH))
