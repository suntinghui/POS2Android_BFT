...
public class AnnouncementDetailActivity extends BaseActivity implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		AnnouncementModel model = (AnnouncementModel) intent
		...
		tv_title.setText(model.getNotice_title() == null ? "" : model
				.getNotice_title());
		tv_content.setText(model.getNotice_content() == null ? "" : model
				.getNotice_content());
